                      ...
                      tabItems(
                        ...
                        tabItem("one",
                                fluidPage(
                                  ...
                                  box(title = "The explainantion of the first two Principal Components", status = "warning", solidHeader = TRUE,plotOutput("Components"), width = 13),
                                  h4("Brush over the plot to select points", align = "center"),
                                  box(title = "Scores plot for PCA with hiearchial clustering", status = "warning", solidHeader = TRUE,plotOutput("PCA", brush = "brush"), width = 13),
                                  h4("View selected Points"),
                                  box(title = "Observations based on the brushed points above",DT::dataTableOutput("selected_points"),status = "warning", solidHeader = TRUE, width = 13),
                                  fluidRow(
                                    box(title = "Chi-square test of Attrition with various Categorical features", status = "warning", solidHeader = TRUE, plotlyOutput("Chi"), height = 550),
                                    box(title = "Proportion of Attrition based on Categorical features", status = "warning",  solidHeader = TRUE, selectInput("cats", "Choose Categorical Variable", categorical),
                                        plotlyOutput("bar_plot_cat"), height = 550)
                                  )
                                )
                        ),
                        # Second tab content
                        tabItem("two",
                                ...
                                box(title = "Decision Tree Graph", plotOutput("tree", height = "500px"), status = "warning", solidHeader = TRUE, width = 13), 
                                box(title = "Partial Dependency Profiles", selectInput("cat_var", "Choosea categorical predictor", c("EducationField", "JobRole",  "BusinessTravel", "MaritalStatus","Gender",  "OverTime")), plotOutput("profiles"), status = "warning", solidHeader = TRUE,  width = 13)
                        ),
                        ...
                        tabItem("three",
                                ...
                                fluidRow(
                                  box(title = "Categorical-Numerical Interactions LRT", status = "warning", solidHeader = TRUE, DT::dataTableOutput("output1")),
                                  box(title = "Ridge Density plots for Categorical-Numerical Interactions with Attrition", status = "warning",  solidHeader = TRUE, plotOutput("density"))
                                ),
                                
                                
                                h4("Click on a row of the Data Table to see a bar plot depicting correlation between categorical features"),
                                fluidRow(
                                  box(title = "Categorical-Categorical Interactions LRT", status = "warning", solidHeader = TRUE, DT::dataTableOutput("output2")),
                                  box(title = "Bar plots for Categorical-Categorical Interactions with Attrition", status = "warning",  solidHeader = TRUE, plotOutput("barplot"))
                                )

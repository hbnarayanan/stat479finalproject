...
p_val=read_csv("https://github.com/hbnarayanan/stat479finalproject/raw/main/p_val.csv")
```
...
#   # print(nrow(job[ex_df$var1_names[i]]))
#   # print(nrow(job[ex_df$var2_names[i]]))
#   # print(nrow(job["Attrition"]))
# mod.b=glm(Attrition ~ job[ex_df$var1_names[i]] + job[ex_df$var2_names[i]] + job[ex_df$var1_names[i]]:job[ex_df$var2_names[i]], data =job, family=binomial(link = "logit"))
# 
#     x=lrtest(mod.b, glm(Attrition ~ ex_df$var1_names[i] + ex_df$var2_names[i], data =job, family=binomial(link = "logit")))
# 
